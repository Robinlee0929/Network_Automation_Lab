...
from phase_2b_09_first_slice_implementation_plan_pack import (
    run_phase_2b_09_first_slice_implementation_plan_pack,
)
...
DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_TASK_ID = "disabled-ai-provider-interface-boundary"
DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_DOC = (
    Path("docs") / "ai-intent" / "day133_disabled_ai_provider_interface_boundary.md"
)
DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_ROADMAP_DOC = (
    Path("docs") / "roadmap" / "day133_disabled_ai_provider_interface_boundary.md"
)
DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_JSON = (
    Path("reports") / "lab-summary" / "day133_disabled_ai_provider_interface_boundary.json"
)
...
DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_TASK_ID = (
    "v04-ai-assistance-phase-gate-closure-review"
)
DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_ROADMAP_DOC = (
    Path("docs") / "roadmap" / "day150_v04_ai_assistance_phase_gate_closure_review.md"
)
DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_AI_INTENT_DOC = (
    Path("docs") / "ai-intent" / "day150_v04_ai_assistance_phase_gate_closure_review.md"
)
DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_JSON = (
    Path("reports") / "lab-summary" / "day150_v04_ai_assistance_phase_gate_closure_review.json"
)
...
PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_TASK_ID = (
    "phase2b-02-safety-gate-design-planning-only"
)
PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_DOC = (
    Path("docs") / "phase_2b" / "phase_2b_02_safety_gate_design_planning_only.md"
)
PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_JSON = (
    Path("reports") / "lab-summary" / "phase_2b_02_safety_gate_design_planning_only.json"
)
...
PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_TASK_ID = (
    "phase2b-09-first-slice-implementation-plan-pack-planning-only"
)
PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_DOC = (
    Path("docs") / "phase_2b" / "phase_2b_09_first_slice_implementation_plan_pack.md"
)
PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_JSON = (
    Path("reports") / "lab-summary" / "phase_2b_09_first_slice_implementation_plan_pack.json"
)
PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_HTML = (
    Path("reports") / "lab-summary" / "phase_2b_09_first_slice_implementation_plan_pack.html"
)
PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_TASK_ID = (
    "phase2b-10-day1-day160-reference-mapping-for-future-first-slice-planning-only"
)
PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_DOC = (
    Path("docs") / "phase_2b" / "phase_2b_10_day1_day160_reference_mapping_for_future_first_slice.md"
)
PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_JSON = (
    Path("reports") / "lab-summary" / "phase_2b_10_day1_day160_reference_mapping_for_future_first_slice.json"
)
...
PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_TASK_ID = "phase2c-07-next-slice-implementation-kickoff-gate"
PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_DOC = (
    Path("docs") / "phase_2c" / "phase_2c_07_next_slice_implementation_kickoff_gate.md"
)
PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_JSON = (
    Path("reports") / "lab-summary" / "phase_2c_07_next_slice_implementation_kickoff_gate.json"
)
...
PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_DOC = (
    Path("docs") / "phase_2c" / "phase_2c_09_post_next_slice_acceptance_review.md"
)
PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_JSON = (
    Path("reports") / "lab-summary" / "phase_2c_09_post_next_slice_acceptance_review.json"
)
PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_HTML = (
    Path("reports") / "lab-summary" / "phase_2c_09_post_next_slice_acceptance_review.html"
)
PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_TASK_ID = (
    "phase2c-10-next-slice-decision-gate-authorization-review"
)
PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_DOC = (
    Path("docs") / "phase_2c" / "phase_2c_10_next_slice_decision_gate_authorization_review.md"
)
PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_JSON = (
    Path("reports") / "lab-summary" / "phase_2c_10_next_slice_decision_gate_authorization_review.json"
)
...
PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_TASK_ID = (
    "phase2c-13-interview-mvp-implementation-slice-safety-delta-review"
)
PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_DOC = (
    Path("docs") / "phase_2c" / "phase_2c_13_interview_mvp_implementation_slice_safety_delta_review.md"
)
PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_JSON = (
    Path("reports") / "lab-summary" / "phase_2c_13_interview_mvp_implementation_slice_safety_delta_review.json"
)
...
REPORT_CATALOG = [
    ...
    },
    {
        ...
        "report_type": "Report-only disabled AI provider interface boundary",
        "safety_label": "AI_PROVIDER_INTERFACE_DISABLED; REVIEW_ONLY; boundary only; not Day134 adapter contract; no execution/provider/API, provider adapter, SDK, external API, API key, secret, network call, live AI call, prompt submission, model selection, async job, retry, rate limit, or timeout provider behavior",
        "description": "Day133 creates a disabled AI provider interface boundary only and does not advance Day134 adapter contract scope.",
        "json_globs": [DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_JSON.as_posix()],
        "html_globs": [DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Review-only v0.4 AI Assistance phase gate closure review",
        "safety_label": "PHASE_GATE_CLOSED_REVIEW_ONLY; NEXT_PHASE_ALLOWED_FALSE; REVIEW_ONLY; REPORT_ONLY; scope=Day145-Day149; execution/provider/API/model/device/SSH/NETCONF/RESTCONF/secrets/live network I/O disabled; future explicit safety gate required",
        "description": "Day150 closes the current v0.4 AI Assistance phase gate as review-only by preserving Day145-Day149 conclusions, confirming README status-summary-only boundaries, and keeping execution, provider, API, model calls, device access, SSH, NETCONF, RESTCONF, secrets, live network I/O, adapters, brokers, runners, and next phase disabled.",
        "json_globs": [DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_JSON.as_posix()],
        "html_globs": [DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Planning-only safety gate design artifact",
        "safety_label": "PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY; PHASE_2B_PLANNING_ONLY_AUTHORIZED_TRUE; PHASE_2B_IMPLEMENTATION_ALLOWED_FALSE; RUNNER_ALLOWED_FALSE; ADAPTER_ALLOWED_FALSE; EXECUTION_ALLOWED_FALSE; FORBIDDEN_CAPABILITIES_ENABLED_FALSE",
        "description": "Phase 2B-02 defines planning-only safety gate design, approval boundaries, failure/stop conditions, required evidence, and implementation prerequisites before any future Phase 2B implementation can be considered. It does not implement Phase 2B, execution, runners, adapters, brokers, schedulers, queue workers, SSH, NETCONF, RESTCONF, live devices, providers/APIs/models, secrets, frontend API integration, backups, VRRP execution, approval bypass, or safety-gate relaxation.",
        "json_globs": [PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_JSON.as_posix()],
        "html_globs": [PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Planning-only first-slice implementation plan pack",
        "safety_label": "PHASE_2B_09_PLANNING_ONLY_DONE; PHASE_2B_08_VERDICT_REFERENCED; PHASE_2B_08_GATE_DUPLICATED_FALSE; FIRST_SLICE_IMPLEMENTED_FALSE; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_FALSE; SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_FALSE; PROVIDER_API_MODEL_SECRETS_TOUCHED_FALSE; SECOND_SAFETY_MATRIX_CREATED_FALSE",
        "description": "Phase 2B-09 produces a planning-only first-slice implementation plan pack. It starts from the Phase 2B-08 GO_TO_2B_09_PLANNING_ONLY gate verdict, plans future file impact, sequence, tests, evidence, rollback, acceptance, and boundary proof, and does not authorize implementation or enable runners, adapters, execution, SSH, NETCONF, RESTCONF, live devices, providers/APIs/models, secrets, frontend integration, backups, validation, command execution, or safety-gate relaxation.",
        "json_globs": [PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_JSON.as_posix()],
        "html_globs": [PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
            f"{PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_TASK_ID}"
        ),
    },
    {
        "day": "Phase 2B",
        "title": "Phase 2B-10 Day1-Day160 Reference Mapping for Future First Slice - Planning Only",
        "report_type": "Planning-only Day1-Day160 reference mapping",
        "safety_label": "PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_PLANNING_ONLY_DONE; DAY1_DAY160_REFERENCED; DAY1_DAY160_REWRITTEN_OR_REPLACED_FALSE; SECOND_SAFETY_MATRIX_CREATED_FALSE; PHASE_2B_05_DUPLICATED_FALSE; PHASE_2B_06_DUPLICATED_FALSE; PHASE_2B_08_DUPLICATED_FALSE; PHASE_2B_09_DUPLICATED_FALSE; FIRST_SLICE_IMPLEMENTED_FALSE; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_FALSE; SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_FALSE; PROVIDER_API_MODEL_SECRETS_TOUCHED_FALSE",
        "description": "Phase 2B-10 produces a planning-only Day1-Day160 reference mapping for a future first slice. It proves reference-only inheritance from existing Day1-Day160, Phase 2A, and Phase 2B controls without duplicating Phase 2B-05, Phase 2B-06, Phase 2B-08, or Phase 2B-09, creating a second safety matrix, authorizing implementation, or enabling runners, adapters, execution, SSH, NETCONF, RESTCONF, live devices, providers/APIs/models, secrets, frontend integration, backups, validation, command execution, or safety-gate relaxation.",
        "json_globs": [PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_JSON.as_posix()],
        "html_globs": [PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Authorization-only next-slice implementation kickoff gate",
        "safety_label": "PHASE_2C_07_AUTHORIZATION_GATE_DONE_PHASE_2C_08_AUTHORIZED_NOT_STARTED; AUTHORIZATION_GATE_ONLY_YES; SELECTED_NEXT_SLICE_ARTIFACT_VALIDATION_JOB; NEXT_SLICE_AUTHORIZED_FOR_PHASE_2C_08_YES; PHASE_2C_08_STARTED_NO; IMPLEMENTATION_ADDED_NO; ARTIFACT_VALIDATION_JOB_IMPLEMENTED_NO; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_NO; SCHEDULER_QUEUE_BROKER_WORKER_AGENT_LOOP_ADDED_NO; SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_NO; PROVIDER_API_MODEL_SECRETS_TOUCHED_NO; REAL_COMMAND_EXECUTION_ADDED_NO; CONFIG_BACKUP_OR_CHANGE_BEHAVIOR_ADDED_NO; DAY1_DAY160_REWRITTEN_OR_REPLACED_NO; SECOND_SAFETY_MATRIX_CREATED_NO",
        "description": "Phase 2C-07 authorizes artifact_validation_job for a later separate Phase 2C-08 using Phase 2C-04, Phase 2C-05, and Phase 2C-06 evidence. It does not start Phase 2C-08, implement the selected slice, or open execution, provider/API/model, secret, SSH, NETCONF, RESTCONF, live-device, backup, config-change, Day1-Day160 replacement, AGENTS.md modification, or second safety-matrix scope.",
        "json_globs": [PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_JSON.as_posix()],
        "html_globs": [PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Report-only post-next-slice acceptance review",
        "safety_label": "PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_REPORT_ONLY; PHASE_2C_09_POST_NEXT_SLICE_ACCEPTED; ACCEPTANCE_DECISION_ACCEPT; PHASE_2C_06_SELECTION_CONFIRMED_YES; PHASE_2C_07_AUTHORIZATION_CONFIRMED_YES; PHASE_2C_08_EVIDENCE_FOUND_YES; ARTIFACT_VALIDATION_JOB_ACCEPTED_YES; NEXT_SLICE_SELECTED_NO; NEXT_IMPLEMENTATION_STARTED_NO; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_NO; SCHEDULER_QUEUE_BROKER_WORKER_AGENT_LOOP_ADDED_NO; SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_NO; PROVIDER_API_MODEL_SECRETS_TOUCHED_NO; CONFIG_BACKUP_CHANGE_BEHAVIOR_ADDED_NO; DAY1_DAY160_REWRITTEN_OR_REPLACED_NO; SECOND_SAFETY_MATRIX_CREATED_NO",
        "description": "Phase 2C-09 reviews existing Phase 2C-08 artifact_validation_job evidence against Phase 2C-06 selection, Phase 2C-07 authorization, and existing report-only / dry-run / mock-only safety boundaries. It does not select another slice, start Phase 2C-10, modify artifact_validation_job, or open execution, live-device, provider/API/model, secret, backup, config-change, Day1-Day160 replacement, or second-safety-matrix scope.",
        "json_globs": [PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_JSON.as_posix()],
        "html_globs": [PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
            f"{PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_TASK_ID}"
        ),
    },
    {
        "day": "Phase 2C",
        ...
        "report_type": "Planning-only next-slice decision gate",
        "safety_label": "PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_PLANNING_ONLY; PHASE_2C_10_NEXT_PLANNING_ALLOWED_IMPLEMENTATION_LOCKED; PHASE_2C_09_ACCEPTANCE_CONFIRMED_YES; PHASE_2C_09_DECISION_ACCEPT; ALLOW_NEXT_PLANNING_YES; NEXT_ALLOWED_PHASE_PHASE_2C_11_NEXT_SLICE_CANDIDATE_INVENTORY_PLANNING_ONLY; DUPLICATES_PHASE_2C_03_PATTERN_REUSE_ONLY; DUPLICATES_DAY1_DAY160_REFERENCE_ONLY; NEXT_SLICE_CANDIDATES_LISTED_NO; NEXT_SLICE_SELECTED_NO; NEXT_IMPLEMENTATION_AUTHORIZED_NO; NEXT_IMPLEMENTATION_STARTED_NO; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_NO; SCHEDULER_QUEUE_BROKER_WORKER_AGENT_LOOP_ADDED_NO; LIVE_DEVICE_SSH_NETCONF_RESTCONF_TOUCHED_NO; PROVIDER_API_MODEL_SECRETS_TOUCHED_NO; CONFIG_BACKUP_OR_CHANGE_BEHAVIOR_ADDED_NO; DAY1_DAY160_REWRITTEN_OR_REPLACED_NO; SECOND_SAFETY_MATRIX_CREATED_NO",
        "description": "Phase 2C-10 reuses the next-slice decision gate pattern after Phase 2C-09 accepted artifact_validation_job evidence. It allows only entry into Phase 2C-11 planning and does not list candidates, select a slice, authorize implementation, start Phase 2C-11, or open execution, live-device, provider/API/model, secret, backup, config-change, Day1-Day160 replacement, or second-safety-matrix scope.",
        "json_globs": [PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_JSON.as_posix()],
        "html_globs": [PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
    ...
    },
    {
        ...
        "report_type": "Planning-only Interview MVP implementation slice safety delta review",
        "safety_label": "PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW; CANDIDATE_SOURCE_PHASE_2C_12_ONLY_YES; NO_NEW_CANDIDATES_INVENTED_YES; SAFETY_DELTA_REVIEW_ONLY_YES; UNIQUE_SLICE_SELECTED_NO; IMPLEMENTATION_AUTHORIZED_NO; IMPLEMENTATION_STARTED_NO; SECOND_SAFETY_MATRIX_CREATED_NO; NEXT_PHASE_STARTED_NO; RUNNER_ADAPTER_EXECUTION_PATH_ADDED_NO; QUEUE_SCHEDULER_WORKER_AI_LOOP_ADDED_NO; SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_NO; PROVIDER_API_MODEL_SECRETS_TOUCHED_NO; CONFIG_BACKUP_CHANGE_ADDED_NO; DAY1_DAY160_REWRITTEN_OR_REPLACED_NO",
        "description": "Phase 2C-13 reviews Phase 2C-12 Interview MVP implementation slice candidates for safety deltas only. It derives candidates only from Phase 2C-12 and does not select a unique slice, authorize implementation, start implementation, start Phase 2C-14, or open runner, adapter, execution, queue, scheduler, worker, AI-loop, live-device, provider/API/model, secret, backup, config-change, Day1-Day160 replacement, or second-safety-matrix scope.",
        "json_globs": [PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_JSON.as_posix()],
        "html_globs": [PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_HTML.as_posix()],
        "missing_note": (
            "Generate with: python network_lab.py --task "
...
def list_tasks() -> List[Dict[str, Any]]:
    return [
        ...
        {
            "id": DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_TASK_ID,
            "task_id": "day133_disabled_ai_provider_interface_boundary",
            "display_name": "Day133 Disabled AI Provider Interface Boundary",
            "user_display_name": "Disabled AI Provider Interface Boundary",
            "day": "Day133",
            "category": "ai_planning",
            "description": "Creates reviewer-visible evidence for a disabled AI provider interface boundary only.",
            "safety_level": "report-only",
            "execution_mode": "report-only",
            "enabled": True,
            "status": "implemented",
            ...
            "produces_report": True,
            "report_paths": [
                DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_JSON.as_posix(),
                DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_HTML.as_posix(),
                DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_DOC.as_posix(),
                DAY133_DISABLED_AI_PROVIDER_INTERFACE_BOUNDARY_ROADMAP_DOC.as_posix(),
            ],
            "report_outputs": [
                "Day133 JSON/HTML disabled AI provider interface boundary",
                "Day133 AI intent and roadmap documentation",
            ],
        ...
        },
        {
            ...
            "day": "Day141",
            "category": "ai_planning",
            "description": "Packages existing Day127-Day140 AI assistance review artifacts into a review-only demo package without source execution, providers, APIs, AI decisions, live access, SSH, folder moves, tmp cleanup, future-day functionality, or next-phase unlock.",
            "safety_level": "report-only",
            "execution_mode": "report-only",
            "enabled": True,
            "status": "implemented",
        ...
        {
            "id": DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_TASK_ID,
            "task_id": "day150_v04_ai_assistance_phase_gate_closure_review",
            "display_name": "Day150 v0.4 AI Assistance Phase Gate Closure Review",
            "user_display_name": "v0.4 AI Assistance Phase Gate Closure Review",
            "day": "Day150",
            "category": "ai_planning",
            "description": "Day150 closes the current v0.4 AI Assistance phase gate as review-only. It preserves Day145-Day149 conclusions, confirms README status-summary-only boundaries, and keeps the next phase blocked pending a future explicit safety gate.",
            "safety_level": "report-only",
            "execution_mode": "report-only",
            "enabled": True,
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_JSON.as_posix(),
                DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_HTML.as_posix(),
                DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_ROADMAP_DOC.as_posix(),
                DAY150_V04_AI_ASSISTANCE_PHASE_GATE_CLOSURE_REVIEW_AI_INTENT_DOC.as_posix(),
            ],
            "report_outputs": [
                "Day150 JSON/HTML v0.4 AI Assistance phase gate closure review",
                "Day150 roadmap documentation",
                "Day150 AI-intent documentation",
            ],
        ...
        {
            "id": PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_TASK_ID,
            "task_id": "phase_2b_02_safety_gate_design_planning_only",
            "display_name": "Phase 2B-02 Safety Gate Design Planning Only",
            "user_display_name": "Phase 2B-02 Safety Gate Design Planning Only",
            "day": "Phase 2B",
            "category": "authorization_scope_gate",
            "description": "Phase 2B-02 defines safety gate design planning only without enabling implementation or execution paths.",
            "safety_level": "report-only",
            "execution_mode": "report-only",
            "enabled": True,
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_JSON.as_posix(),
                PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_HTML.as_posix(),
                PHASE_2B_02_SAFETY_GATE_DESIGN_PLANNING_ONLY_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2B-02 JSON/HTML planning-only safety gate design artifact",
                "Phase 2B-02 review documentation",
            ],
        ...
        {
            "id": PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_TASK_ID,
            "task_id": "phase_2b_09_first_slice_implementation_plan_pack",
            "display_name": "Phase 2B-09 First-Slice Implementation Plan Pack - Planning Only",
            "user_display_name": "Phase 2B-09 First-Slice Implementation Plan Pack - Planning Only",
            "day": "Phase 2B",
            "category": "authorization_scope_gate",
            "description": "Phase 2B-09 plans how a future smallest first implementation slice should be sequenced, constrained, tested, reviewed, stopped, and rolled back while remaining planning-only.",
            "safety_level": "planning-only",
            "execution_mode": "planning-only",
            "enabled": True,
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_JSON.as_posix(),
                PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_HTML.as_posix(),
                PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2B-09 JSON/HTML planning-only first-slice implementation plan pack",
                "Phase 2B-09 implementation plan pack planning documentation",
            ],
            "related_script": "phase_2b_09_first_slice_implementation_plan_pack.py",
            "notes": "PHASE_2B_09_FIRST_SLICE_IMPLEMENTATION_PLAN_PACK_PLANNING_ONLY PHASE_2B_09_PLANNING_ONLY_DONE AGENTS_MD_FOUND_AND_READ AGENTS_MD_NOT_MODIFIED SCOPE_CONFIRMATION_PASS PHASE_GOAL_CONFIRMED EXAMPLE_JOB_TYPES_TREATED_AS_EXAMPLES_ONLY FORBIDDEN_SCOPE_PRESERVED EXISTING_ARTIFACTS_REFERENCED IMPLEMENTATION_BOUNDARY_PRESERVED PHASE_2B_08_VERDICT_REFERENCED PHASE_2B_08_GATE_DUPLICATED_FALSE FIRST_SLICE_IMPLEMENTED_FALSE RUNNER_ADAPTER_EXECUTION_PATH_ADDED_FALSE SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_FALSE PROVIDER_API_MODEL_SECRETS_TOUCHED_FALSE SAFETY_GATES_REBUILT_OR_REPLACED_FALSE SECOND_SAFETY_MATRIX_CREATED_FALSE. Planning-only first-slice implementation plan pack; no Phase 2B implementation slice, Phase 2B-08 gate duplication or re-run, safety gate rebuild, safety gate replacement, second safety matrix, runner, adapter, broker, scheduler, queue worker, background worker, SSH, NETCONF, RESTCONF, live device, provider/API/model calls, secrets handling, frontend integration, real execution, real backup, real validation, command execution, approval bypass, or safety gate weakening.",
        },
        {
            "id": PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_TASK_ID,
            "task_id": "phase_2b_10_day1_day160_reference_mapping_for_future_first_slice",
            "display_name": "Phase 2B-10 Day1-Day160 Reference Mapping for Future First Slice - Planning Only",
            "user_display_name": "Phase 2B-10 Day1-Day160 Reference Mapping for Future First Slice - Planning Only",
            "day": "Phase 2B",
            "category": "authorization_scope_gate",
            "description": "Phase 2B-10 maps future first-slice planning concerns back to existing Day1-Day160, Phase 2A, and Phase 2B controls while remaining planning-only.",
            "safety_level": "planning-only",
            "execution_mode": "planning-only",
            "enabled": True,
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_JSON.as_posix(),
                PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_HTML.as_posix(),
                PHASE_2B_10_DAY1_DAY160_REFERENCE_MAPPING_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2B-10 JSON/HTML planning-only Day1-Day160 reference mapping",
                "Phase 2B-10 Day1-Day160 reference mapping planning documentation",
            ],
        ...
        {
            "id": PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_TASK_ID,
            "task_id": "phase_2c_07_next_slice_implementation_kickoff_gate",
            "display_name": "Phase 2C-07 Next-Slice Implementation Kickoff Gate - Authorization Only",
            "user_display_name": "Phase 2C-07 Next-Slice Implementation Kickoff Gate - Authorization Only",
            "day": "Phase 2C",
            "category": "planning_review",
            "description": "Phase 2C-07 authorizes artifact_validation_job for a later separate Phase 2C-08 using Phase 2C-04, Phase 2C-05, and Phase 2C-06 evidence without implementing it or starting Phase 2C-08.",
            "safety_level": "report-only",
            "enabled": True,
            "execution_mode": "report-only",
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_JSON.as_posix(),
                PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_HTML.as_posix(),
                PHASE_2C_07_NEXT_SLICE_IMPLEMENTATION_KICKOFF_GATE_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2C-07 JSON/HTML next-slice authorization evidence",
                "Phase 2C-07 authorization-only kickoff documentation",
            ],
        ...
        },
        {
            ...
            "task_id": "phase_2c_09_post_next_slice_acceptance_review",
            "display_name": "Phase 2C-09 Post-Next-Slice Acceptance Review - Report Only",
            "user_display_name": "Phase 2C-09 Post-Next-Slice Acceptance Review - Report Only",
            "day": "Phase 2C",
            "category": "acceptance_review",
            "description": "Phase 2C-09 reviews existing Phase 2C-08 artifact_validation_job evidence against Phase 2C-06 selection, Phase 2C-07 authorization, and existing report-only / dry-run / mock-only safety boundaries.",
            "safety_level": "report-only",
            "enabled": True,
            "execution_mode": "report-only",
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_JSON.as_posix(),
                PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_HTML.as_posix(),
                PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2C-09 JSON/HTML post-next-slice acceptance evidence",
                "Phase 2C-09 report-only acceptance review documentation",
            ],
            "related_script": "phase_2c_09_post_next_slice_acceptance_review.py",
            "notes": "PHASE_2C_09_POST_NEXT_SLICE_ACCEPTANCE_REVIEW_REPORT_ONLY PHASE_2C_09_POST_NEXT_SLICE_ACCEPTED ACCEPTANCE_DECISION_ACCEPT AGENTS_MD_FOUND_YES AGENTS_MD_READ_BEFORE_ACTION_YES AGENTS_MD_MODIFIED_NO SCOPE_CONFIRMED_IN_WRITING_YES NEEDS_SCOPE_CONFIRMATION_NO PHASE_2C_06_SELECTION_CONFIRMED_YES PHASE_2C_07_AUTHORIZATION_CONFIRMED_YES PHASE_2C_08_EVIDENCE_FOUND_YES ARTIFACT_VALIDATION_JOB_ACCEPTED_YES REPORT_ONLY_ARTIFACT_CREATED_YES NEXT_SLICE_SELECTED_NO NEXT_IMPLEMENTATION_STARTED_NO RUNNER_ADAPTER_EXECUTION_PATH_ADDED_NO SCHEDULER_QUEUE_BROKER_WORKER_AGENT_LOOP_ADDED_NO SSH_NETCONF_RESTCONF_LIVE_DEVICE_TOUCHED_NO PROVIDER_API_MODEL_SECRETS_TOUCHED_NO CONFIG_BACKUP_CHANGE_BEHAVIOR_ADDED_NO DAY1_DAY160_REWRITTEN_OR_REPLACED_NO SECOND_SAFETY_MATRIX_CREATED_NO. Report-only acceptance review; reviews existing Phase 2C-08 artifact_validation_job evidence against Phase 2C-06 selection and Phase 2C-07 authorization, not a new implementation slice, next-slice selection, Phase 2C-10 start, runner, adapter, broker, scheduler, queue, worker, agent loop, execution path, provider/API/model call, secret handling, SSH, NETCONF, RESTCONF, live device access, real command execution, backup behavior, config change behavior, AGENTS.md modification, Day1-Day160 rewrite or replacement, second safety matrix, approval bypass, or safety gate weakening.",
        },
        {
            "id": PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_TASK_ID,
            "task_id": "phase_2c_10_next_slice_decision_gate_authorization_review",
            "display_name": "Phase 2C-10 Next-Slice Decision Gate / Authorization Review - Planning Only",
            "user_display_name": "Phase 2C-10 Next-Slice Decision Gate / Authorization Review - Planning Only",
            "day": "Phase 2C",
            "category": "authorization_gate",
            "description": "Phase 2C-10 decides whether the project may enter Phase 2C-11 planning after Phase 2C-09 accepted artifact_validation_job evidence.",
            "safety_level": "report-only",
            "enabled": True,
            "execution_mode": "report-only",
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_JSON.as_posix(),
                PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_HTML.as_posix(),
                PHASE_2C_10_NEXT_SLICE_DECISION_GATE_AUTHORIZATION_REVIEW_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2C-10 JSON/HTML next-planning authorization evidence",
                "Phase 2C-10 planning-only decision gate documentation",
            ],
        ...
        {
            "id": PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_TASK_ID,
            "task_id": "phase_2c_13_interview_mvp_implementation_slice_safety_delta_review",
            "display_name": "Phase 2C-13 Interview MVP Implementation Slice Safety Delta Review - Planning Only",
            "user_display_name": "Phase 2C-13 Interview MVP Implementation Slice Safety Delta Review - Planning Only",
            "day": "Phase 2C",
            "category": "planning",
            "summary": "Reviews Phase 2C-12 Interview MVP implementation slice candidates for safety deltas without selecting or authorizing a slice.",
            "description": "Planning-only safety delta review over Phase 2C-12 Interview MVP implementation slice candidates; no unique slice selection, implementation authorization, implementation start, runner, adapter, execution path, queue, scheduler, worker, AI loop, live-device access, provider/API/model, secrets, config backup/change behavior, Day1-Day160 replacement, or second safety matrix is added.",
            "command": f"python network_lab.py --task {PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_TASK_ID}",
            "enabled": True,
            "safety_level": "report-only",
            "execution_mode": "report-only",
            "requires_live_device": False,
            ...
            "produces_report": True,
            "report_paths": [
                PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_JSON.as_posix(),
                PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_HTML.as_posix(),
                PHASE_2C_13_INTERVIEW_MVP_IMPLEMENTATION_SLICE_SAFETY_DELTA_REVIEW_DOC.as_posix(),
            ],
            "report_outputs": [
                "Phase 2C-13 JSON/HTML Interview MVP safety delta review evidence",
                "Phase 2C-13 planning-only safety delta review documentation",
            ],
...
def _run_phase_2b_09_first_slice_implementation_plan_pack(project_root: Path) -> int:
    return run_phase_2b_09_first_slice_implementation_plan_pack(
        project_root,
        format_heading_func=format_heading,
        format_status_func=format_status,
        relative_to_project_func=_relative_to_project,
...
def _run_phase_2c_09_post_next_slice_acceptance_review(project_root: Path) -> int:
    return run_phase_2c_09_post_next_slice_acceptance_review(
        project_root,
        format_heading_func=format_heading,
        format_status_func=format_status,
        relative_to_project_func=_relative_to_project,
