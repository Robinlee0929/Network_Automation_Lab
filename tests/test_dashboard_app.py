...
def test_ai_intent_reviewer_references_day57_to_day81():
...
def test_ai_intent_reviewer_route_exposes_day57_to_day81_without_execution(tmp_path):
    if dashboard.Flask is None:
        pytest.skip("Flask is not installed in this test environment.")
    ...
    day81_section = html.split("<h3>read-only broker review queue", 1)[1]
