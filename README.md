...
| 41A | 2L-02C | Report-index Registry Expectation Review / Planning Only | DONE / READY_FOR_REVIEW | Registry expectation mismatches confirmed for required Day4 runtime outputs and configured Day8 filenames; no correction or implementation authorized |
| 41B | 2L-02D | Report-index Registry Correction Authorization Gate / Planning Only | NEW / FUTURE | Selected next planning-only candidate; do not start without a separate task |
