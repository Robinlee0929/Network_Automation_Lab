...
10. If running the dashboard locally, open `/ai-intent-reviewer` for the Day57-Day64 reviewer UI entry point, Day62 scenario pack link, Day63 traceability evidence map link, and Day64 acceptance runbook link.
