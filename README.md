...
- `docs/phase_2d/` is the current Phase 2D planning lane after Phase 2C closure. Phase 2D-00 is the entry gate that records `ALLOW_PHASE_2D_PLANNING`, allows only Phase 2D-01 as planning-only, and does not authorize implementation, select a Phase 2D slice, continue Phase 2C, create Phase 2C-28, or add execution-capable behavior.
