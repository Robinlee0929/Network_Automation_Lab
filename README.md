...
10. If running the dashboard locally, open `/ai-intent-reviewer` for the Day57-Day71 reviewer UI entry point, Day62 scenario pack link, Day63 traceability evidence map link, Day64 acceptance runbook link, Day65 sign-off package link, Day66 offline mock runtime skeleton link, Day67 contract validation link, Day68 reviewer quality status, Day69 scenario evidence drilldown, Day70 AI runtime readiness gate, and Day71 controlled AI runtime entry design.
