...
10. If running the dashboard locally, open `/ai-intent-reviewer` for the Day57-Day63 reviewer UI entry point, Day62 scenario pack link, and Day63 traceability evidence map link.
